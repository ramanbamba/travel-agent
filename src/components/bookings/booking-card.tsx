...
import { ChevronDown, Copy, Plane } from "lucide-react";
        ...
        <div className="mt-3 flex items-center justify-between">
          <div className="flex items-center gap-2">
            {booking.pnr && (
              <button
                onClick={copyPnr}
                className="flex items-center gap-1 rounded bg-white/5 px-2 py-0.5 font-mono text-xs text-muted-foreground transition-colors hover:bg-white/10 hover:text-foreground"
              >
                {booking.pnr}
